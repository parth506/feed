...
import {
  ...
  Portal,
  Root
} from "./chunk-FUGRBUH3.js";
import {
  createCollection
} from "./chunk-VAUEEEQL.js";
import {
  Presence,
...
var ToastAnnounce = __name2((props) => {
  ...
  return isAnnounced ? null : (0, import_jsx_runtime2.jsx)(Portal, { asChild: true, container: context.announcerContainer || void 0, children: (0, import_jsx_runtime2.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastAnnounceExclude = React2.forwardRef(__name2(function ToastAnnounceExclude2(props, forwardedRef) {
